          ...
          <div class="main-protocolo row">
            <div class="content-protocolo">
              ...
              <div class="d-flex flex-column flex-md-row justify-content-between">
                <div class="col-left">
                  <?php 
                  $num_protocolo = get_post_meta(get_the_ID(), 'numero_protocolo', true);
                  if (isset($num_protocolo)) { ?>
                    ...
                    <?php }  else { ?>
                      <div class="num-protocolo title-28 switzerlandBold"><?php echo __('Protocolo: #'). $_GET['input-protocolo']; ?></div>
                      <div>
